...
public class ImpulseMainMenu extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(mc.fontRendererObj, "v" + Impulse.INSTANCE.VERSION, width/1.53f, height/5.4f, -1);
		if (!Impulse.INSTANCE.newUpdate) {
			...
			this.drawCenteredString(mc.fontRendererObj, EnumChatFormatting.RAINMBOW + "New update, re-run the installer to install", width/2f, height/3.5f, -1);
		}
		GlStateManager.pushMatrix();
	...
	@Override
	public void initGui() {
		this.buttonList.add(new GuiButton(1, this.width/2 - 97, height / 2 -  60, "Singleplayer", true));
		this.buttonList.add(new GuiButton(2, this.width/2 - 97, height / 2 -  40, "Multiplayer", true));
		this.buttonList.add(new GuiButton(3, this.width/2 - 97, height / 2 + -15, 96, 20, "Options...", true));
		this.buttonList.add(new GuiButton(4, this.width/2 - (1 / 8) + 7 , height / 2 + -15, 96, 20, "Quit", true));
		super.initGui();
	}
