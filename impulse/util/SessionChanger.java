...
public class SessionChanger {
	...
	private SessionChanger() {
		String notSureWhyINeedThis = "d3d46add-30f0-4c1e-89fe-3bd7e49bf460"; //Idk, needs a UUID. Seems to be fine making it random
		AuthenticationService authService = new YggdrasilAuthenticationService(Minecraft.getMinecraft().getProxy(), notSureWhyINeedThis);
